...
static constexpr auto qt_meta_stringdata_CLASSMessageTextEditENDCLASS = QtMocHelpers::stringData(
    "MessageTextEdit",
    "send",
    "",
    "textEditChanged"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSMessageTextEditENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSMessageTextEditENDCLASS_t qt_meta_stringdata_CLASSMessageTextEditENDCLASS = {
    {
        QT_MOC_LITERAL(0, 15),  // "MessageTextEdit"
        QT_MOC_LITERAL(16, 4),  // "send"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 15)   // "textEditChanged"
    },
    "MessageTextEdit",
    "send",
    "",
