...
Q_CONSTINIT static const qt_meta_stringdata_CLASSChatPageENDCLASS_t qt_meta_stringdata_CLASSChatPageENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 19),  // "sig_append_chat_msg"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 29),  // "std::shared_ptr<TextChatData>"
        QT_MOC_LITERAL(60, 3),  // "msg"
        QT_MOC_LITERAL(64, 19)   // "on_send_btn_clicked"
    },
    "ChatPage",
    "sig_append_chat_msg",
    "",
...
void ChatPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sig_append_chat_msg((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<TextChatData>>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ChatPage::sig_append_chat_msg; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatPage::sig_append_chat_msg(std::shared_ptr<TextChatData> _t1)
{
