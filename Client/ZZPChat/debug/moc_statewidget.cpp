...
static constexpr auto qt_meta_stringdata_CLASSStateWidgetENDCLASS = QtMocHelpers::stringData(
    "StateWidget",
    "Clicked",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSStateWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSStateWidgetENDCLASS_t qt_meta_stringdata_CLASSStateWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11),  // "StateWidget"
