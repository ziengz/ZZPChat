...
void AuthenFriend::InitTipLbs()
{
    ...
    for(int i = 0;i < _tip_datas.size();i++){
        ...
        connect(lb,&ClickedLabel::Click,this,&AuthenFriend::SlotChangeFriendLabelByTip);
...
void AuthenFriend::SlotChangeFriendLabelByTip(QString text, ClickLbState state)
{
